...
import com.uasz.daos.deroulement.service.ClasseService;
...
public class ClasseController {
    ...
    // Les formulaires web seront désactivés pour l'instant
     ...
     * TODO: Intégrer avec maquette-service pour récupérer filieres et niveaux
     */
    @RequestMapping("/add-classe")
    public String addClasse(Model model) {
        Classe classe = new Classe();
        model.addAttribute("classe", classe);
        // TODO: Récupérer filieres et niveaux via maquette-service
        return "classe-add";
    }
    ...
    public String saveClasse(@Valid @ModelAttribute("classe") Classe classe,
        ...
        try {
            ...
            // TODO: Gérer les IDs de filière et niveau via formulaire
            if (classe.getFiliereId() != null) {
                classeDTO.setFiliereId(classe.getFiliereId());
            }
            if (classe.getNiveauId() != null) {
                classeDTO.setNiveauId(classe.getNiveauId());
            }
