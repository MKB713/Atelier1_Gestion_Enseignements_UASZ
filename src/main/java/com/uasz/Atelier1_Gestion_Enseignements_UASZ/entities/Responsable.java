...
public class Responsable {
    ...
    // Relation avec Formation (un responsable est responsable d'une formation)
    @ManyToOne
    @JoinColumn(name = "formation_id")
    private Formation formation;

    // Optionnel: relation avec Enseignant si le responsable est aussi enseignant
    @ManyToOne
    ...
    public Responsable(String nom, String prenom, String email, TypeResponsable type) {
        this();
        this.nom = nom;
        this.prenom = prenom;
        this.email = email;
